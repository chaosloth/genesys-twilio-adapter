...
//Compiles all html templates into a .js file to be loaded into angular's $templateCache, so http requests do not need to be made to fetch the templates
    ngtemplates: {
	    'ark': {
		    cwd: '<%= yeoman.app %>',
		    src: 'modules/**/*.html',
		    dest: '<%= yeoman.app %>/modules/main/templates.js'
	    }
    },
